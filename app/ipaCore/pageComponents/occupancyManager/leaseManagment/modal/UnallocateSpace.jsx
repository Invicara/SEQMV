...
const UnallocateSpace = ({ isOpen, onClose, isSuccessOrFailMsg, userInfo, mode, ...props }) => {
    ...
    // const deleteCompProps = props.handler.config.actions.Delete.component || {}
    const unallocateSpace = async () => {
        ...
        const updateSpace = await ScriptCache.runScript(props.handler.config.actions.Create.script, updatedItemArray)
