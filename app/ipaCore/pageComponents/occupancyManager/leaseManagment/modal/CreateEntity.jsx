...
const CreateEntity = ({ isOpen, onClose, isSuccessOrFailMsg, spaceInfo, mode, ...props }) => {
    ...
    const entityTitle = props.handler.config.type.singular

    const createCompProps = props.handler.config.actions.Create.component || {}
    ...
    const createEntity = async () => {
        ...
        const allocateSpace = await ScriptCache.runScript(props.handler.config.actions.Create.script, updatedItemArray)
                ...
                <div className="modal-body">
                    <div className="move-user-grid">
                        ...
                        <div className="move-user-column">
                            {
                                props.handler.config.actions.Create.component.fields.map(field => {
                                    if (field.type === 'text') {
                                        return (
                                            <div key={field.name}>
